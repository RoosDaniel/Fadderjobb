...
(function () {
    ...
    var DateTimeShortcuts = {
        ...
        handleClockQuicklink: function (num, val) {
            ...
            DateTimeShortcuts.clockInputs[num].dispatchEvent(new Event('input', {bubbles: true}));
            DateTimeShortcuts.dismissClock(num);
        },
        ...
        handleCalendarCallback: function (num) {
            ...
            return function (y, m, d) {
                ...
                DateTimeShortcuts.calendarInputs[num].dispatchEvent(new Event('input', {bubbles: true}));
